...
renderView.CameraPosition = [0.0025, 0.0, 0.009669473398112754]
renderView.CameraFocalPoint = [0.0025, 0.0, 0.0]
renderView.CameraParallelScale = 0.0025026438715437696
