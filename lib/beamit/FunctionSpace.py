...
class EulerBernoulliFunctionSpace():
    ...
    def __init__(self, s0, s1, E, discretization_type = "CG"):
        ...
        # the lifting shape functions evaluated at quadrature points (size = (integration points, dimensions, total dofs))
    ...
    # Function to compute lifting shape functions of the element at any point
    def compute_lifting_shapes(self, xi):
        ...
        # elemental shape function matrices
        axial_lifting_shapes = np.array([[k01, 0.0, 0.0, k12, 0.0, 0.0]])

        return axial_lifting_shapes
    ...
    def discretize(self):
        ...
        for i in range(0, self.Q):
            ...
            el_axial_lifting_shapes = self.compute_lifting_shapes(integration_points[i])
